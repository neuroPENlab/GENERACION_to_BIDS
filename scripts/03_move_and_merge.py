...
meta_create()
local_bids_path = meta_func("bids_ws", "the path to the temporary workspace BIDS folder")
destination_bids_path = meta_func("bids", "the path to the archive BIDS folder") 
